...
# Download from here https://fasttext.cc/docs/en/english-vectors.html
embedding_dict = gensim.models.KeyedVectors.load_word2vec_format("/media/asabir/Marina/fast_text_pre-trained_embedding/crawl-300d-2M.vec", binary=False)
...
# fastext based visual re-ranker
...
input_path = 'visual_fastext_result.txt'
