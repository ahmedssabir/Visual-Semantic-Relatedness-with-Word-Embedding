...
from gensim.scripts.glove2word2vec import glove2word2vec
glove2word2vec(glove_input_file="babelfy_vectors", word2vec_output_file="gensim_glove_vectors.txt")
...
#  sene embedding based visual re-ranker
...
input_path = 'visual_sense_emb_result.txt'
